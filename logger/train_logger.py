...
class TrainLogger(BaseLogger):
    ...
    def log_iter(self, inputs, logits, targets, unweighted_loss, weighted_loss, optimizer, phase='train'):
        ...
        if self.iter % self.iters_per_print == 0 or phase != 'train':
        ...
        # TODO (amit): change how often we log val.
        if self.iter % self.iters_per_visual == 0:
            self.visualize(inputs, logits, targets, phase=phase)
